        ...
        {!isSubmitted ? (
          <form onSubmit={handleSubmit}>
            ...
            <motion.button
              ...
              whileTop={{ scale: 0.98 }}
              className="w-full py-3 px-4 bg-gradient-to-r from-green-500 to-emerald-500 to-emerald-600 text-white
          ...
          <div className="text-center">
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              transtition={{ type: "spring", stiffness: 500, damping: 30 }}
              className="w-16 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-4"
            >
